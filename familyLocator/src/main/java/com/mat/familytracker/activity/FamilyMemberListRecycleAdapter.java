...
public class FamilyMemberListRecycleAdapter extends GenericRecyclerViewAdapter {
    ...
    public FamilyMemberListRecycleAdapter(Activity context, BaseRecyclerListener listener, List items) {
        super(context, listener, items);
        this.mActivity = context;
        this.mListener = listener;
        this.modelList = items;
        this.contactsMap = FTApplication.getContactsMap();
        this.fileUtils = new ImageSaver(mActivity);
    }

    @Override
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.family_member_list_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int pos) {
        ...
        final FamilyMemberModel familyMemberDetail = modelList.get(position);
        ...
        if (familyMemberDetail.isRegistered()) {
            ...
            viewHolder.gpsStatus.setVisibility(View.GONE);
            viewHolder.msg.setVisibility(View.GONE);
        }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.onItemClicked(familyMemberDetail, position);
            }
        });
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                mListener.onItemLongPressed(familyMemberDetail, position);
                return false;
            }
        });
    }
...
//            objData.put("priority", "high");
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mobile = (TextView) view.findViewById(R.id.family_mbr_list_mobile);
            name = (TextView) view.findViewById(R.id.family_mbr_list_name);
            relation = (TextView) view.findViewById(R.id.family_mbr_list_relation);
            gpsStatus = (TextView) view.findViewById(R.id.family_mbr_list_gps_status);
            invite = (TextView) view.findViewById(R.id.family_mbr_list_invite);
            profilePic = view.findViewById(R.id.family_mbr_list_profilepic);
            msg = view.findViewById(R.id.family_mbr_list_msg);
            msg.setVisibility(View.VISIBLE);
            call = view.findViewById(R.id.family_mbr_list_call);
        }
