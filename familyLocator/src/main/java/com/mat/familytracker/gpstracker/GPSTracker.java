...
public class GPSTracker implements LocationListener {
    ...
    private long mMIN_DISTANCE_CHANGE_FOR_UPDATES = 20; // 0 meters
    private long mMIN_TIME_BW_UPDATES = 5000 /** 60 * 1*/
            ; // 1 minute
    private LocationCallback mLocationCallback;

    public GPSTracker(Context context, GPSTrackerListener gpsTrackerListener, boolean isContinuous) {
        this.mContext = context;
        this.isContinuous = isContinuous;
        this.gpsTrackerListener = gpsTrackerListener;
        this.mMIN_DISTANCE_CHANGE_FOR_UPDATES = Constants.MIN_DISTANCE_OF_TRACKING; // distance in meters
        this.mMIN_TIME_BW_UPDATES = Constants.MIN_TIME_OF_TRACKING; // in seconds
        try {
