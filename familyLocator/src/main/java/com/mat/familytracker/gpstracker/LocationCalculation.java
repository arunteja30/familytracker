...
public class LocationCalculation extends Location {

    private boolean bUseMetricUnits = false;

    public LocationCalculation(Location location) {
        this(location, true);
    }

    public LocationCalculation(Location location, boolean bUseMetricUnits) {
